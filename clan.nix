{ inputs, lib, ... }:
{
  ...
  modules."@UnstoppableMango/apiserver" = lib.importApply ./modules/service/apiserver { inherit inputs; };
  modules."@UnstoppableMango/kubelet" = lib.importApply ./modules/service/kubelet { inherit inputs; };
  modules."@UnstoppableMango/loadbalancer" = lib.importApply ./modules/service/loadbalancer { inherit inputs; };
  modules."@UnstoppableMango/network" = lib.importApply ./modules/service/network { inherit inputs; };
  modules."@UnstoppableMango/kubeconfig" = lib.importApply ./modules/service/kubeconfig { inherit inputs; };
